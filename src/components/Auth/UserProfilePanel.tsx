...
export const UserProfilePanel: React.FC = () => {
  ...
  return (
    <div className="space-y-4 relative text-left">
      {/* Toast notification */}
      {toast && (
        <div className="flex items-center gap-2.5 px-4 py-3 rounded-xl border text-xs font-medium bg-black border-zinc-800 text-zinc-200">
          {toast.type === 'success'
      ...
      {/* Profile Header */}
      <div className="flex items-center gap-4 p-4 rounded-xl border border-zinc-800 bg-zinc-905 bg-black">
        <img
          src={avatarUrl}
          alt="Profile"
          className="w-14 h-14 rounded-xl border border-zinc-800 object-cover bg-black"
        />
        <div className="flex-1 min-w-0">
          {editingName ? (
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 text-sm font-bold bg-black border border-zinc-800 rounded-lg px-2.5 py-1.5 text-zinc-200 focus:outline-none focus:border-zinc-500"
              />
              <button
              ...
              <button
                ...
                className="p-1.5 rounded-lg border border-zinc-800 text-zinc-400 hover:bg-zinc-900 transition-colors cursor-pointer"
              >
          ...
          <div className="flex items-center gap-1.5 mt-2 flex-wrap">
            {hasGitHub && (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[9px] font-bold bg-black text-zinc-300 border border-zinc-800">
            ...
            {linkedProviders.length === 0 && (
              <span className="text-[9px] text-zinc-400">No providers linked</span>
            )}
          </div>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        {/* GitHub row */}
        <div className="flex items-center justify-between p-3 rounded-xl border border-zinc-800 bg-black">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[9px] text-zinc-400">{hasGitHub ? (githubToken ? 'Connected · API access active' : 'Linked · no API token') : 'Not connected'}</p>
            </div>
          </div>
          {hasGitHub ? (
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1.5 text-[9px] font-bold rounded-lg border border-zinc-800 text-zinc-400 hover:border-zinc-700 hover:text-white bg-black transition-colors cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1.5 text-[9px] font-bold rounded-lg border border-zinc-800 text-zinc-350 hover:bg-zinc-900 bg-black transition-colors cursor-pointer disabled:opacity-50"
            >
              <FiLink className="w-3 h-3" />
        ...
        <div className="flex items-center justify-between p-3 rounded-xl border border-zinc-800 bg-black">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[9px] text-zinc-400">{hasGoogle ? 'Connected' : 'Not connected'}</p>
            </div>
          </div>
          {hasGoogle ? (
            <button
      ...
      <div className="space-y-2 pt-1">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-2.5 text-xs font-bold text-zinc-300 border border-zinc-800 rounded-xl hover:bg-zinc-900 hover:border-zinc-700 bg-black transition-colors cursor-pointer"
        >
        ...
        {!showDeleteConfirm ? (
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2 text-[10px] font-semibold text-zinc-400 hover:text-white transition-colors cursor-pointer"
          >
            <FiTrash2 className="w-3 h-3" />
            Delete Account
          </button>
        ) : (
          <div className="p-3.5 rounded-xl border border-zinc-800 bg-black space-y-2.5">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 py-1.5 text-[10px] font-bold border border-zinc-800 rounded-lg text-zinc-400 hover:bg-black cursor-pointer transition-colors"
              >
                Cancel
              </button>
              <button
