...
export const LoginScreen: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-900 flex overflow-hidden">
      ...
      {/* ── LEFT PANEL: Branding ── */}
      <div className="hidden lg:flex lg:w-[52%] flex-col justify-between p-25 bg-neutral-900 text-white border-r border-zinc-800 relative overflow-hidden">
          ...
          <div className="space-y-3.5">
            {FEATURES.map(f => (
              <div key={f.title} className="flex items-start gap-3.5">
                <div className="w-8 h-8 rounded-lg bg-neutral-900 border border-zinc-800 flex items-center justify-center text-zinc-400 shrink-0 mt-0.5">
                  {f.icon}
                </div>
                <div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 md:p-12 bg-neutral-900">
        <div className="w-full max-w-sm space-y-6">
          ...
          {/* Error banner */}
          {error && (
            <div className="flex items-start gap-3 px-4 py-3.5 rounded-xl border border-zinc-800 bg-neutral-900">
          ...
          {linkingState && (
            <div className="px-4 py-4 rounded-xl border border-zinc-800 bg-neutral-900 space-y-3">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3.5 px-5 py-3.5 bg-neutral-900 hover:bg-zinc-800 text-zinc-100 font-semibold text-sm rounded-xl border border-zinc-800 disabled:opacity-60 active:scale-[0.98] transition-all shadow-sm cursor-pointer"
            >
              {loading === 'google' ? (
          ...
          <label className="flex items-center gap-2.5 cursor-pointer group select-none">
            <div
              ...
              className={`w-4 h-4 rounded border flex items-center justify-center transition-colors cursor-pointer ${remember
                ? 'bg-white border-white'
                : 'border-zinc-800 bg-neutral-900'
                }`}
            >
              {remember && (
